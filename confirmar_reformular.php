...
<div class="tabcontent"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="500" class="factura-texto4"><a name="contenido" id="contenido"></a>Reformular Proyecto</td>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="sombra">
  <tr>
    <td bgcolor="#FFFFFF"><br />
<form action="engines/reformular.php" method="post">
<table width="950" border="0" align="center" cellpadding="4" cellspacing="0">
        <tr>
          <td align="center"><img src="imagenes/reformular.png" width="100" height="100" /></td>
        </tr>
        <tr>
          <td align="center"><strong class="factura-texto4">Solicitar Reformulación</strong></td>
        </tr>
        <tr>
          <td align="center">¿El cliente requiere la reformulación del proyecto <strong><?php echo $nombre_proyecto; ?></strong>?
        ...
        <tr>
          <td align="center" class="factura-texto2"><br />
            <table width="500" border="0" cellspacing="0" cellpadding="4">
              <tr>
                <td class="factura-texto3"><strong class="factura-texto2">Comentarios de la Reformulación</strong></td>
                </tr>
              <tr>
                <td><textarea name="comentarios" class="textbox-box" id="comentarios" autocomplete="off" placeholder="Indique las características de la reformulación del proyecto <?php echo $nombre_proyecto ?>" required="required"></textarea></td>
                </tr>
              </table></td>
        </tr>
      </table>
      ...
      <table width="480" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          <td align="center"><input class="boton-creformular" type="submit" name="reformular" id="reformular" value="Solicitar Reformulación" /></td>
        </tr>
        <tr>
