...
<div class="tabcontent"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="500" class="factura-texto4"><a name="contenido" id="contenido"></a>Prioridad del Proyecto</td>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="sombra">
  <tr>
    <td bgcolor="#FFFFFF"><br />
      <form action="engines/prioridad.php" method="post"><table width="950" border="0" align="center" cellpadding="4" cellspacing="0">
        <tr>
          <td align="center"><img src="imagenes/prioridad.png" width="100" height="100" /></td>
        </tr>
        <tr>
          <td align="center" class="factura-texto4"><strong>Cambiar Prioridad</strong></td>
        </tr>
        <tr>
          <td align="center">Cambiar la prioridad del proyecto <strong><?php echo $nombre_proyecto; ?></strong> a:<input type="hidden" id="id_proyecto" name="id_proyecto" value="<?php echo $id; ?>"><input type="hidden" id="id_usuario" name="id_usuario" value="<?php echo $id_usuario; ?>"></td>
        </tr>
        <tr>
          <td align="center" class="factura-texto2"><br />
            <select name="prioridad" class="textbox-med" id="prioridad" style="height:30px;">
        ...
        <tr>
          <td align="center" class="subtitulo"><br />
            Prioridad Actual del Proyecto: <?php if ($prioridad=="Urgente"){echo "<span class='texto-urgente'>Urgente</span>";} else {echo $prioridad;} ?>  <?php switch ($prioridad) {
    				case 'Alta':
      ...
      <table width="480" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          <td align="center"><input class="boton-login" type="submit" name="boton_prioridad" id="boton_prioridad" value="Cambiar Prioridad" /></td>
        </tr>
        <tr>
          <td align="center" class="subtitulo"><br />
