...
<div class="tabcontent"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="500" class="factura-texto4"><a name="contenido" id="contenido"></a>Aprobar Proyecto</td>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="sombra">
  <tr>
    <td bgcolor="#FFFFFF"><br />
<form action="engines/aprobar.php" method="post">
<table width="950" border="0" align="center" cellpadding="4" cellspacing="0">
        ...
        <tr>
          <td align="center"><strong class="factura-texto4">¡Felicidades!</strong></td>
        </tr>
        <tr>
          <td align="center">El proyecto <strong><?php echo $nombre_proyecto; ?></strong> fue aprobado por el cliente.
        ...
        <tr>
          <td align="center" class="factura-texto2"><br />
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="4">
              <tr>
                <td class="factura-texto3"><strong class="factura-texto2">El Cliente aprobó el proyecto por</strong></td>
              </tr>
              <tr>
                <td><select name="tipo_aprobacion" class="textbox-login" id="tipo_aprobacion" style="height:30px; width:490px;">
      ...
      <table width="480" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          <td align="center"><input class="boton-caprobar" type="submit" name="aprobar" id="aprobar" value="Confirmar Aprobación del Proyecto" /></td>
        </tr>
        <tr>
