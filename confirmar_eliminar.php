...
<div class="tabcontent"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="500" class="factura-texto4"><a name="contenido" id="contenido"></a>Eliminar Proyecto</td>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="sombra">
  <tr>
    <td bgcolor="#FFFFFF"><br />
      <form action="engines/eliminar.php" method="post"><table width="950" border="0" align="center" cellpadding="4" cellspacing="0">
        <tr>
          <td align="center"><img src="imagenes/elimnar.png" width="100" height="100" /></td>
        </tr>
        <tr>
          <td align="center" class="factura-texto4"><strong>Eliminar Proyecto</strong></td>
        </tr>
        <tr>
          <td align="center">¿Desea eliminar el proyecto <strong><?php echo $nombre_proyecto; ?></strong> permanentemente?</td>
        </tr>
        <tr>
          <td align="center" class="factura-texto-min">Si el proyecto es eliminado, no podrá ser recuperado.
      ...
      <table width="480" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          <td align="center"><input class="boton-celiminar" type="submit" name="eliminar" id="eliminar" value="Confirmar: Eliminar Proyecto" /></td>
        </tr>
        <tr>
