...
<div class="tabcontent"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="500" class="factura-texto4"><a name="contenido" id="contenido"></a>Editar Proveedor</td>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="sombra">
  <tr>
    <td align="center" bgcolor="#FFFFFF"><br />
      <form action="engines/modificar_proveedor.php?id=<?php echo $infoarray->id_proveedor; ?>" method="post"><table width="550" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          <td width="420">Nombre del Proveedor</td>
          <td width="130" align="right" class="subtitulo">ID: <span class="generado-asignado"><?php echo $infoarray->id_proveedor ?></span></td>
        </tr>
        <tr>
          <td colspan="2"><input name="nombre" type="text" required="required" class="textbox" id="nombre" placeholder="Ejemplo: ALKAN Quimica S.A. de C.V." autocomplete="off" value="<?php echo $infoarray->nombre; ?>"/></td>
        </tr>
      </table>
        <br />
      <table width="480" border="0" align="center" cellpadding="0" cellspacing="2">
        ...
        <tr>
          <td align="center" class="subtitulo"><br />
            ó <a href="proveedores.php#contenido">Cancelar</a></td>
        </tr>
      </table>
      </form><br /></td>
  </tr>
