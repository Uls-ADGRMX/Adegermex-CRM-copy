...
<div class="tabcontent"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="500" class="factura-texto4"><a name="contenido" id="contenido"></a>Cancelar la Venta del Proyecto</td>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="sombra">
  <tr>
    <td bgcolor="#FFFFFF"><br />
      <form action="engines/cancelar_venta.php" method="post"><table width="950" border="0" align="center" cellpadding="4" cellspacing="0">
        <tr>
          <td align="center"><img src="imagenes/bad.png" width="100" height="100" /></td>
        </tr>
        <tr>
          <td align="center" class="factura-texto4"><strong>Cancelar la Venta del Proyecto</strong></td>
        </tr>
        <tr>
          <td align="center">¿Desea cancelar la venta del proyecto <strong><?php echo $nombre_proyecto; ?></strong>?</td>
        </tr>
        <tr>
          <td align="center" class="factura-texto-min">Este proceso no podrá revertirse.
        ...
        <tr>
          <td align="center" class="factura-texto2"><br />
            <table width="500" border="0" cellspacing="0" cellpadding="4">
              <tr>
                <td class="factura-texto3"><strong class="factura-texto2">Motivo de la cancelación</strong></td>
              </tr>
              <tr>
                <td><textarea name="comentarios" class="textbox-box" id="comentarios" autocomplete="off" placeholder="Indique el motivo de la cancelación de la venta del proyecto <?php echo $nombre_proyecto; ?>" required="required"></textarea></td>
              </tr>
            </table></td>
        </tr>
      </table>
      ...
      <table width="480" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          <td align="center"><input class="boton-celiminar" type="submit" name="eliminar" id="eliminar" value="Confirmar: Cancelar la Venta del Proyecto" /></td>
        </tr>
        <tr>
