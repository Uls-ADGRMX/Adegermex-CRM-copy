  ...
  <tr>
    <td bgcolor="#FFFFFF" align="center"><br />
      <table width="900" border="0" cellspacing="0" cellpadding="4">
        <tr>
          <td align="center" class="titulo">Proyectos por Agente de Ventas conteo por Desarrollador</td>
        </tr>
        <tr>
...
while($fila=mysql_fetch_array($agentes)){
	...
	SELECT DISTINCT tmproyectos.id_usuasignado, COUNT(tmproyectos.id_usuasignado) AS numero_proyectos, tcusuarios.id_usuario, tcusuarios.nombre AS desarrollador
	FROM tmproyectos
	JOIN tcusuarios
	WHERE tmproyectos.id_usugenera='$us' AND tmproyectos.id_usuasignado = tcusuarios.id_usuario AND tmproyectos.fecha_generacion BETWEEN '$fecha_inicial' AND '$fecha_final' GROUP BY desarrollador ORDER BY numero_proyectos DESC",$conexion);
