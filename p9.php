  ...
  <tr>
    <td bgcolor="#FFFFFF" align="center"><br />
      <table width="900" border="0" cellspacing="0" cellpadding="4">
        <tr>
          <td align="center" class="titulo">Proyectos por Desarrollador</td>
        </tr>
        <tr>
...
while($fila=mysql_fetch_array($desarrolladores)){
	$ds = $fila['id_usuario'];
	$proyectos = mysql_query("SELECT tmproyectos.*, tcclientes.id_cliente, tcclientes.nombre AS cliente FROM tmproyectos JOIN tcclientes WHERE tmproyectos.id_cliente = tcclientes.id_cliente AND id_usuasignado = $ds AND tmproyectos.fecha_generacion BETWEEN '$fecha_inicial' AND '$fecha_final' ORDER BY status ASC",$conexion);
