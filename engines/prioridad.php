...
$modificar = mysql_query("UPDATE tmproyectos SET prioridad='$prioridad' WHERE id_proyecto='$id_proyecto'", $conexion);
		if (!$modificar) {
			echo '<script language="javascript">alert("Cation : Proyectos\n\nError al cambiar la Prioridad del Proyecto")</script>';
...
// Insertar Evento ////////////////////////////////////
///////////////////////////////////////////////////////
$evento = "La prioridad del Proyecto fue cambiada a <strong>".$prioridad."</strong> por ";
$insertar = mysql_query("INSERT INTO tmeventos (id_proyecto, id_usuario, tipo_evento, fecha, hora, evento)
		...
		if (!$insertar) {
			...
			echo '<script language="javascript">alert("Cation : Proyectos\n\nSe cambio la prioridad del proyecto correctamente.")</script>';
