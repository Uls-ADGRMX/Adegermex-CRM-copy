...
$fecha=date("Y-m-d");
$hora=date("H:i:s");
$modificar = mysql_query("UPDATE tmproyectos SET status='Remuestreo' WHERE id_proyecto='$id_proyecto'", $conexion);
		if (!$modificar) {
...
$evento = "Se solicitó el <strong>Remuestreo</strong> del proyecto por el Cliente, lo indicó ";
...
$comentario = "<strong>Comentario del Remuestreo</strong>: ".$comentarios;
...
echo '<script language="javascript">alert("Cation : Proyectos\n\nSe solicitó el remuestreo correctamente.")</script>';
