...
$fecha=date("Y-m-d");
$hora=date("H:i:s");
$modificar = mysql_query("UPDATE tmproyectos SET status='Reformular' WHERE id_proyecto='$id_proyecto'", $conexion);
		if (!$modificar) {
...
$evento = "Se solicitó la <strong>Reformulación</strong> del proyecto por el Cliente, lo indicó ";
...
$comentario = "<strong>Comentario de la Reformulación</strong>: ".$comentarios;
...
echo '<script language="javascript">alert("Cation : Proyectos\n\nSe solicitó la reformulación correctamente.")</script>';
