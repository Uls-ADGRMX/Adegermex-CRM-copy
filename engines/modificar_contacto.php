...
// Modificar Contacto /////////////////////////////////
///////////////////////////////////////////////////////
$modificar = mysql_query("UPDATE tmcontactos SET nombre_contacto='$nombre_contacto', telefono='$telefono', correo='$correo', puesto='$puesto', departamento='$departamento' WHERE id_contacto='$id_contacto'", $conexion);
	if (!$modificar) {
		echo '<script language="javascript">alert("Cation : Clientes\n\nError al modificar la información del contacto.")</script>';
...
// Insertar Evento ////////////////////////////////////
///////////////////////////////////////////////////////
$evento = "Se modificó un <strong>Contacto</strong> del cliente, registrado por";
...
echo '<script language="javascript">alert("Cation : Clientes\n\nSe modificó el contacto correctamente.")</script>';
echo "<script language='javascript'>window.location='../cliente.php?id=".$id_cliente."#contactos'</script>";
die();
