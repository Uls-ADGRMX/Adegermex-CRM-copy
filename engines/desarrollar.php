...
$modificar = mysql_query("UPDATE tmproyectos SET fecha_inicio='$fecha', hora_inicio='$hora', status='En Desarrollo' WHERE id_proyecto='$id'", $conexion);
		if (!$modificar) {
...
// Insertar Evento ////////////////////////////////////
///////////////////////////////////////////////////////
$evento = "Se inicio el desarrollo del proyecto por ";
...
echo '<script language="javascript">alert("Cation : Proyectos\n\nSe inicio el desarrollo del proyecto correctamente.")</script>';
