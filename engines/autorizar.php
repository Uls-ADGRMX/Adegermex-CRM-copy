...
$fecha=date("Y-m-d");
$hora=date("H:i:s");
$modificar = mysql_query("UPDATE tmproyectos SET status='Autorizado', id_usuautoriza='$id_usuario', fecha_autorizacion='$fecha', hora_autorizacion='$hora' WHERE id_proyecto='$id'", $conexion);
		if (!$modificar) {
...
$evento = "El proyecto de desarrollo fue <strong>Autorizado</strong> por ";
...
echo '<script language="javascript">alert("Cation : Proyectos\n\nEl proyecto se autorizó correctamente.")</script>';
