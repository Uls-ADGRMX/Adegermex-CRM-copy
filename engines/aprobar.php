...
$fecha=date("Y-m-d");
$hora=date("H:i:s");
$modificar = mysql_query("UPDATE tmproyectos SET status='Aprobado', fecha_aprobacion='$fecha', hora_aprobacion='$hora', aprobacion='$tipo_aprobacion' WHERE id_proyecto='$id_proyecto'", $conexion);
		if (!$modificar) {
...
$evento = "El proyecto de desarrollo fue <strong>Aprobado</strong> por el Cliente, lo indicó ";
...
echo '<script language="javascript">alert("Cation : Proyectos\n\nEl proyecto se aprobó correctamente.")</script>';
