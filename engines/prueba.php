...
$modificar = mysql_query("UPDATE tmproyectos SET status='Prueba Piloto' WHERE id_proyecto='$id'", $conexion);
		if (!$modificar) {
...
// Insertar Evento ////////////////////////////////////
///////////////////////////////////////////////////////
$evento = "El proyecto entra en etapa de <strong>Prueba Piloto</strong>, lo indicó ";
...
echo '<script language="javascript">alert("Cation : Proyectos\n\nSe reportó el proyecto en prueba piloto correctamente.")</script>';
