...
$tipo_noaprobacion = $_POST['tipo_noaprobacion'];
$comentarios = $_POST['comentarios'];
$comentarios = ucfirst($comentarios);
date_default_timezone_set('America/Mexico_City');
$fecha=date("Y-m-d");
$hora=date("H:i:s");
$modificar = mysql_query("UPDATE tmproyectos SET status='No Aprobado', noaprobacion='$tipo_noaprobacion' WHERE id_proyecto='$id_proyecto'", $conexion);
		if (!$modificar) {
...
$evento = "El proyecto de desarrollo <strong>No fue Aprobado</strong> por el Cliente, lo indicó ";
...
$comentario = "<strong>Comentario del Cliente</strong>: ".$comentarios;
...
echo '<script language="javascript">alert("Cation : Proyectos\n\nEl proyecto se desaprobó correctamente.")</script>';
