...
$fecha=date("Y-m-d");
$hora=date("H:i:s");
$modificar = mysql_query("UPDATE tmproyectos SET status='Rechazado' WHERE id_proyecto='$id_proyecto'", $conexion);
		if (!$modificar) {
...
$comentario = "<strong>Motivo de rechazo del proyecto</strong>: ".$comentarios;
...
$evento = "El proyecto fue <strong>Rechazado</strong> por ";
...
echo '<script language="javascript">alert("Cation : Proyectos\n\nEl proyecto se rechazó correctamente.")</script>';
