...
$fecha=date("Y-m-d");
$hora=date("H:i:s");
$modificar = mysql_query("UPDATE tmproyectos SET status='Enviado al Cliente' WHERE id_proyecto='$id'", $conexion);
		if (!$modificar) {
...
// Insertar Evento ////////////////////////////////////
///////////////////////////////////////////////////////
$evento = "Se realizó la <strong>Entrega al Cliente</strong> de muestras e información del proyecto, por parte de ";
...
echo '<script language="javascript">alert("Cation : Proyectos\n\nSe reportó la entrega al cliente correctamente.")</script>';
