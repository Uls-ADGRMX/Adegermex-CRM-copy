  ...
  <tr>
    <td bgcolor="#FFFFFF" align="center"><br />
      <table width="900" border="0" cellspacing="0" cellpadding="4">
        <tr>
          <td align="center" class="titulo">Proyectos por Cliente</td>
        </tr>
        <tr>
...
$clientes=mysql_query("SELECT DISTINCT tcclientes.nombre, tcclientes.id_cliente
FROM tcclientes
JOIN tmproyectos
WHERE tcclientes.id_cliente = tmproyectos.id_cliente ORDER BY tcclientes.nombre ASC",$conexion);
while($fila=mysql_fetch_array($clientes)){
	$cl = $fila['id_cliente'];
	$proyectos = mysql_query("SELECT tmproyectos.*, tcusuarios.nombre as generador FROM tmproyectos JOIN tcusuarios WHERE tmproyectos.id_usugenera = tcusuarios.id_usuario AND tmproyectos.id_cliente='$cl' AND tmproyectos.fecha_generacion BETWEEN '$fecha_inicial' AND '$fecha_final' ORDER BY tmproyectos.id_proyecto ASC",$conexion);
