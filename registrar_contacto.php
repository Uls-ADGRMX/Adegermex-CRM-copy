...
<div class="tabcontent"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="500" class="factura-texto4"><a name="contenido" id="contenido"></a>Registrar Contacto</td>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="sombra">
  <tr>
    <td align="center" bgcolor="#FFFFFF"><br />
      <form action="engines/registrar_contacto.php" method="post"><table width="950" border="0" align="center" cellpadding="4" cellspacing="0">
        <tr>
          <td align="center"><img src="imagenes/registrar_contacto.png" width="100" height="100" /></td>
        </tr>
        <tr>
          <td align="center" class="factura-texto4"><strong>Registrar Contacto</strong></td>
        </tr>
      </table>
        <br />
        <table width="950" border="0" align="center" cellpadding="4" cellspacing="0">
          <tr>
            <td align="center">Registrar nuevo contacto para el  cliente <strong><?php echo $nombre_cliente; ?></strong>:
        ...
        <table width="800" border="0" cellspacing="0" cellpadding="4">
          ...
          <tr>
            <td><input name="nombre_contacto" type="text" class="textbox-med" id="nombre_contacto" placeholder="Nombre del contacto" autocomplete="off" required="required" autofocus="autofocus"/></td>
        ...
        <table width="480" border="0" align="center" cellpadding="0" cellspacing="2">
          <tr>
          <td align="center"><input class="boton-casignar" type="submit" name="registrar" id="registrar" value="Registrar Contacto" /></td>
        </tr>
        <tr>
