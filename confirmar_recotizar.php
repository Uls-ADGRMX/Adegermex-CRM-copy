...
<div class="tabcontent"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="500" class="factura-texto4"><a name="contenido" id="contenido"></a>Recotizar Proyecto</td>
...
<form action="engines/recotizar.php" method="post">
<table width="950" border="0" align="center" cellpadding="4" cellspacing="0">
        <tr>
          <td align="center"><img src="imagenes/recotizar.png" width="100" height="100" /></td>
        </tr>
        <tr>
          <td align="center"><strong class="factura-texto4">Solicitar Recotización</strong></td>
        </tr>
        <tr>
          <td align="center">¿El cliente requiere la recotización del proyecto <strong><?php echo $nombre_proyecto; ?></strong>?
        ...
        <tr>
          <td align="center" class="factura-texto2"><br />
            <table width="500" border="0" cellspacing="0" cellpadding="4">
              <tr>
                <td class="factura-texto3"><strong class="factura-texto2">Comentarios de la Recotización</strong></td>
                </tr>
              <tr>
                <td><textarea name="comentarios" class="textbox-box" id="comentarios" autocomplete="off" placeholder="Indique los ajustes comerciales que se requieren para el proyecto <?php echo $nombre_proyecto ?>" required="required"></textarea></td>
                </tr>
              </table></td>
        </tr>
      </table>
      ...
      <table width="480" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          <td align="center"><input class="boton-crecotizar" type="submit" name="recotizar" id="recotizar" value="Solicitar Recotización" /></td>
        </tr>
        <tr>
