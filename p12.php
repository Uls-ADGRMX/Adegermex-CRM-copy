  ...
  <tr>
    <td bgcolor="#FFFFFF" align="center"><br />
      <table width="900" border="0" cellspacing="0" cellpadding="4">
        <tr>
          <td align="center" class="titulo">Proyectos por Agente de Ventas conteo por Tipo de Proyecto</td>
        </tr>
        <tr>
...
while($fila=mysql_fetch_array($agentes)){
	...
	SELECT DISTINCT tmproyectos.tipo, COUNT(tmproyectos.tipo) AS numero_proyectos
	FROM tmproyectos
	WHERE tmproyectos.id_usugenera='$us' AND tmproyectos.fecha_generacion BETWEEN '$fecha_inicial' AND '$fecha_final' GROUP BY tmproyectos.tipo ORDER BY numero_proyectos DESC",$conexion);
	...
	$totalp = $filatotal['totalp'];
		  echo '<table width="600" border="0" align="center" cellpadding="4" cellspacing="0">
			<tr class="encabezado-tabla">
				<td width="300">Tipo de Proyecto</td>
