...
<div class="tabcontent">
  <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="500" class="factura-texto4"><a name="contenido" id="contenido"></a>Editar Cliente</td>
      <td width="500" align="right" class="factura-texto4">&nbsp;</td>
    </tr>
  </table>
  <form action="engines/modificar_cliente.php?id=<?php echo $infoarray->id_cliente; ?>&usuario=<?php echo $id_usuario; ?>" method="post">
  <br />
    ...
    <tr>
      <td align="center" bgcolor="#FFFFFF"><br />
        ...
        <table width="550" border="0" align="center" cellpadding="0" cellspacing="2">
          ...
          <tr>
            <td><input name="nombre" type="text" required="required" class="textbox" id="nombre" placeholder="Ejemplo: Adegermex S.A. de C.V." autocomplete="off" autofocus="autofocus" value="<?php echo $infoarray->nombre; ?>"/></td>
          </tr>
        </table>
        <br />
        <table width="800" border="0" align="center" cellpadding="4" cellspacing="0">
          ...
          <tr>
            <td><input name="rfc" type="text" class="textbox-med" id="rfc" placeholder="Ejemplo: ADE8703309B6" autocomplete="off" required="required" value="<?php echo $infoarray->rfc; ?>"/></td>
            <td><select name="tipo" class="textbox-med" id="tipo" style="height:35px;">
            	<option><?php echo $infoarray->tipo; ?></option>
                <optgroup label="Tipo">
            ...
            <td><select name="pertenece" class="textbox-med" id="pertenece" style="height:35px;">
           	  <option><?php echo $infoarray->pertenece; ?></option>
        ...
        <table width="800" border="0" align="center" cellpadding="4" cellspacing="0">
          ...
          <tr>
            <td><input name="calle" type="text" class="textbox-med" id="calle" placeholder="Calle" autocomplete="off" required="required" value="<?php echo $infoarray->calle; ?>"/></td>
            <td><input name="exterior" type="text" class="textbox-min" id="exterior" placeholder="# Exterior" autocomplete="off" required="required" value="<?php echo $infoarray->exterior; ?>"/></td>
            <td><input name="interior" type="text" class="textbox-min" id="interior" placeholder="# Interior" autocomplete="off" value="<?php echo $infoarray->interior; ?>"/></td>
          </tr>
        </table>
        <br />
        <table width="800" border="0" align="center" cellpadding="4" cellspacing="0">
          ...
          <tr>
            <td><input name="colonia" type="text" class="textbox-med" id="colonia" placeholder="Colonia" autocomplete="off" required="required" value="<?php echo $infoarray->colonia; ?>"/></td>
            <td><input name="municipio" type="text" class="textbox-med" id="municipio" placeholder="Municipio o Localidad" autocomplete="off" required="required" value="<?php echo $infoarray->municipio; ?>"/></td>
            <td><input name="estado" type="text" class="textbox-med" id="estado" placeholder="Estado o Provincia" autocomplete="off" required="required" value="<?php echo $infoarray->estado; ?>"/></td>
          </tr>
        </table>
        <br />
        <table width="800" border="0" align="center" cellpadding="4" cellspacing="0">
          ...
          <tr>
            <td><select name="pais" class="textbox-med" id="pais" style="height:35px;">
              <option><?php echo $infoarray->pais; ?></option>
            ...
            <td><input name="cp" type="number" class="textbox-min" id="cp" placeholder="#" autocomplete="off" step="1" min="1" required="required" value="<?php echo $infoarray->cp; ?>"/></td>
          </tr>
        </table>
        <br />
        <br />
    ...
    <tr>
      <td align="center" bgcolor="#FFFFFF"><br />
        ...
        <table width="800" border="0" align="center" cellpadding="4" cellspacing="0">
          ...
          <tr>
            <td><select name="origen" class="textbox-med" id="origen" style="height:35px;">
              <?php if($oorigen=="0") { echo "<option>".$infoarray->origen."</origen>"; }?>
            ...
            <td><input type="checkbox" name="check_origen" id="check_origen" onchange="javascript:mostrarOrigen()" <?php if($oorigen=="1") { echo "checked"; } ?>/>
              Otro origen</td>
            <td><div id="divorigen" style="display:<?php if($oorigen=="1") { echo "block"; } else { echo "none"; } ?>;">
              <input type="text" class="textbox-med" placeholder="Indique otro origen" name="otro_origen" id="otro_origen" autocomplete="off" style="height:20px; width:320px;" value="<?php if($oorigen=="1") { echo $infoarray->origen; } else { echo ""; } ?>"/>
            </div></td>
          </tr>
        </table>
        <br />
        ...
        <table width="800" border="0" align="center" cellpadding="4" cellspacing="0">
          ...
          <tr>
            <td><textarea name="instrucciones" cols="50" rows="5" class="textbox-comentario" id="instrucciones" placeholder="Indique referencias del domicilio, horario de recepción, persona que recibe, requisitos para ingreso o alguna información relevante" required="required" style="width:780px;"><?php echo $infoarray->instrucciones; ?></textarea></td>
          </tr>
        </table>
        <br />
        <br /></td>
        ...
        <table width="800" border="0" align="center" cellpadding="4" cellspacing="0">
          <tr>
            ...
            <select name="segmento" class="textbox-med" id="segmento" style="height:35px;">
              	<option><?php echo $infoarray->segmento; ?></option>
          ...
          <tr>
            ...
            <td><textarea name="estrategia" cols="50" rows="5" class="textbox-comentario" id="estrategia" placeholder="Describa la estrategia de negocio del cliente" style="width:550px;"><?php echo $infoarray->estrategia; ?></textarea></td>
          </tr>
          <tr>
            <td>Estrategía de negocio interna</td>
            <td><textarea name="interna" cols="50" rows="5" class="textbox-comentario" id="interna" placeholder="Describa la estrategia de negocio interna a seguir para el cliente" style="width:550px;"><?php echo $infoarray->interna; ?></textarea></td>
          </tr>
          <tr>
            <td>Líneas de negocio</td>
            <td><textarea name="lineas" cols="50" rows="5" class="textbox-comentario" id="lineas" placeholder="Describa las líneas de negocio en tiene el cliente" style="width:550px;"><?php echo $infoarray->lineas; ?></textarea></td>
          </tr>
          <tr>
            <td>Tipos de productos</td>
            <td><textarea name="productos" cols="50" rows="5" class="textbox-comentario" id="productos" placeholder="Describa los tipos de productos que produce o comercializa el cliente" style="width:550px;"><?php echo $infoarray->productos; ?></textarea></td>
          </tr>
          <tr>
            <td>Procesos</td>
            <td><textarea name="procesos" cols="50" rows="5" class="textbox-comentario" id="procesos" placeholder="Describa los procesos que tiene el cliente" style="width:550px;"><?php echo $infoarray->procesos; ?></textarea></td>
          </tr>
        </table>
        <br />
        <br /></td>
    ...
    <tr>
      <td align="center" bgcolor="#FFFFFF"><br />
        ...
        <table width="800" border="0" cellspacing="0" cellpadding="4">
          ...
          <tr>
            <td><input name="nombre_contacto" type="text" class="textbox-med" id="nombre_contacto" placeholder="Nombre del contacto" autocomplete="off" required="required" value="<?php echo $infoarray->nombre_contacto; ?>"/></td>
            <td><input name="telefono" type="tel" class="textbox-med" id="telefono" placeholder="Teléfono" autocomplete="off" required="required" value="<?php echo $infoarray->telefono; ?>"/></td>
            <td><input name="correo" type="email" class="textbox-med" id="correo" placeholder="Correo electrónico" autocomplete="off" required="required" value="<?php echo $infoarray->correo; ?>"/></td>
          </tr>
        </table>
        <br />
        <table width="800" border="0" cellspacing="0" cellpadding="4">
          ...
          <tr>
            <td><input name="puesto" type="text" class="textbox-med" id="puesto" placeholder="Puesto" autocomplete="off" required="required" value="<?php echo $infoarray->puesto; ?>"/></td>
