  ...
  <tr>
    <td bgcolor="#FFFFFF" align="center"><br />
      <table width="900" border="0" cellspacing="0" cellpadding="4">
        <tr>
          <td align="center" class="titulo">Proyectos por Desarrollador conteo por Status</td>
        </tr>
        <tr>
...
while($fila=mysql_fetch_array($desarrolladores)){
	...
	FROM tmproyectos
	WHERE tmproyectos.id_usuasignado='$ds' AND tmproyectos.fecha_generacion BETWEEN '$fecha_inicial' AND '$fecha_final' GROUP BY tmproyectos.status ORDER BY numero_proyectos DESC",$conexion);
